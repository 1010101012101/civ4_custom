...
void CvPlayerAI::AI_conquerCity(CvCity* pCity)
{
	...
	{
	    iRazeValue = 0;
		int addCost=CalculateDistanceMaintenanceTimes100(pCity)+CalculateNumCitiesMaintenanceTimes100(getNumCities()+1,16);
		addCost=addCost/100;
		if (getNumCities() > 2 && AI_isFinancialTroubleMore(NULL,addCost))
		{
			iRazeValue+=120;
		}
...
// XXX
bool CvPlayerAI::AI_isFinancialTroubleMore(int* earnFund,int addedCost) const
{
