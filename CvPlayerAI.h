...
public:
  ...
  static CvPlayerAI& getPlayer(PlayerTypes ePlayer) 
  {
	...
	void AI_doPeace();
	int AI_CalcNewCityCost(CvCity* pCity) const;
...
/************************************************************************************************/
	bool AI_isFinancialTroubleAddCost(int* earnFund=NULL,int addedCost=0) const;
...
/************************************************************************************************/
	...
	int m_NewCityCostCache;
	int m_NewCityCostCityNumCache;
